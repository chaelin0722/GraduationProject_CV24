...
public class Getjson extends AppCompatActivity {
    ...
    private void showResult(){
        ...
        String TAG_ID = "id";
        String TAG_SITUATION = "situation";
        ...
        try {
            ...
            for(int i=0;i<jsonArray.length();i++){
                ...
                String situation = item.getString(TAG_SITUATION);
                ...
                totalData.setMember_id(id);
                totalData.setMember_situation(situation);
                totalData.setMember_time(time);
                totalData.setMember_latitude(latitude);
                totalData.setMember_longitude(longitude);
